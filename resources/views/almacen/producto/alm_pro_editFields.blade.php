      ...
      <div class="row">
        ...
        <div class="form-group col-sm btn-sm">
          ...
          <div class="input-group">
            ...
            {!! Form::text('costo_de_armado', $producto->cost_arm, ['id' => 'costo_de_armado', 'class' => 'form-control' . ($errors->has('costo_de_armado') ? ' is-invalid' : ''), 'maxlength' => 15, 'placeholder' => __('Costo de gel'), 'onChange' => 'calcularPecioCliente();']) !!}
