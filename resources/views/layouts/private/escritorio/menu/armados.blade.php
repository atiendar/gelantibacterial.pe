@canany(['armado.index', 'armado.create', 'armado.show', 'armado.edit', 'armado.destroy', 'armado.clon.index', 'armado.clon.create', 'armado.clon.show', 'armado.clon.edit', 'armado.clon.destroy', 'armado.producto.create', 'armado.producto.destroy', 'armado.producto.editCantidad', 'armado.clon.producto.create', 'armado.clon.producto.destroy', 'armado.clon.producto.editCantidad', 'armado.stock.index', 'armado.stock.show', 'armado.stock.aumentarStock', 'armado.stock.disminuirStock'])
